    ...
    <div className='min-h-screen'>
      ...
      <WeatherBackground  condition={getWeatherCondition()}/>
       ...
       <div className='flex items-center justify-center p-6 min-h-screen'>
        <div className='bg-transparent backdrop-filter backdrop-blur-md rounded-x1 shadow-2xl p-8 max-w-md text-white
              ...
              <button onClick={() => {setWeather(null); setCity('')}}
                ...
                <div className='flex justify-between items-center'>
                  ...
                  <button onClick={() => setUnit(u => u === 'C' ? 'F' : 'C')}
                    className='bg-blue-700 hover:bg-blue-800 text-whitem font-semibold py-1 px-3 rounded
                    transition-colors'>
                      &deg;{unit}
                    </button>
                </div>
